...
export default function YoutubeViewerStory({video, landscap, notautoplay}) {
  const url = video.url
  ...
  return (
    <div className={styles.containerGlobal}>
      ...
      src={'https://www.youtube.com/embed/'+url+'?'+(notautoplay? '' :'autoplay=1&')+'loop=1&rel=0&showinfo=0'}
